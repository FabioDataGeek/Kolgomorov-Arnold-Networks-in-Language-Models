...
seeds = [43, 44, 45, 46]
implementations = ['Baseline', 'Fair_baseline']
BATCH_SIZE = {
    'boolq': 6,
    'cb': 6,
    'copa': 6,
    ...
    for task in BENCHMARKS[benchmark]:
        ...
        for seed in seeds:
            ...
            training_args = TrainingArguments(
                output_dir=f"/workspace/experiments/kan_heads/results_hf/{args['implementation']}_BERT_FINAL_{args['experiment']}_seed_{seed}/{args['benchmark']}/{args['task']}",
                logging_dir='/logs',
                seed=seed,
                num_train_epochs=10,
            ...
            trainer = RollingMetricsTrainer(
                ...
                callbacks=[SaveEvaluationResultsCallback(args['benchmark'], args['task'], args['experiment'], args['implementation'], seed=seed), 
                        SaveLossesCallback(f"/workspace/experiments/kan_heads/results_hf/{args['implementation']}_BERT_FINAL_{args['experiment']}_seed_{seed}/{args['benchmark']}/{args['task']}"), 
                        TimeCallback(f"/workspace/experiments/kan_heads/results_hf/{args['implementation']}_BERT_FINAL_{args['experiment']}_seed_{seed}/{args['benchmark']}/{args['task']}"), 
                        GradientStatsCallback(store_stats=True, output_dir=f"/workspace/experiments/kan_heads/results_hf/{args['implementation']}_BERT_FINAL_{args['experiment']}_seed_{seed}/{args['benchmark']}/{args['task']}"),
                        GeneralCalibrationCallback(output_dir=f"/workspace/experiments/kan_heads/results_hf/{args['implementation']}_BERT_FINAL_{args['experiment']}_seed_{seed}/{args['benchmark']}/{args['task']}")],
